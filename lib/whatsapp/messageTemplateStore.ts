...
const FALLBACK_TEMPLATES: WhatsAppMessageTemplateRow[] = [
  ...
  },
  {
    ...
    notes:
      "MSG91 name is vendor_assign_driver_v3 (UTILITY, same 9 body variables + one dynamic URL button as v2, simplified CTA copy, approved 2026-09-24). v2 stays available on MSG91 but is no longer sent to.",
    active: true,
  },
  {
