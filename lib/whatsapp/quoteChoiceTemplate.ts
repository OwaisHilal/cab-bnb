 ...
 * - Quick-reply titles at send time are `Select {vendorName}` (≤ 20 chars).
 *   Meta/MSG91 Utility templates freeze QR titles at approval, so live vendor
 *   names go out on the session interactive path.
